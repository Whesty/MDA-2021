...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(200, "Лексический анализатор: Неинцилизораванная переменная"),
		...
		ERROR_ENTRY(308, "Семантическая ошибка: Кол-во ожидаемыех и переданных функция и параметров не совпадают"),
		...
		ERROR_ENTRY(606, "Синтаксическая ошибка: Неверная стурктура условия"),
